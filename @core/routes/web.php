...
Route::group(['middleware' => ['setlang','globalVariable']],function (){
    ...
    Route::get('/about','FrontendController@about_page')->name('frontend.about');
    ...
    Route::get('/team','FrontendController@team_page')->name('frontend.team');
    Route::get('/blog/{id}/{any}','FrontendController@blog_single_page')->name('frontend.blog.single');
    Route::get('/services/{id}/{any}','FrontendController@services_single_page')->name('frontend.services.single');
    Route::get('/work/{id}/{any}','FrontendController@work_single_page')->name('frontend.work.single');
