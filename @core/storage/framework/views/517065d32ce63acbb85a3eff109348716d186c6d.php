                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.homeone.section.manage')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="home_page_build_dream_section_status"><strong><?php echo e(__('Build Dream Section Show/Hide')); ?></strong></label>
                                        <label class="switch">
                                            <input type="checkbox" name="home_page_build_dream_section_status"  <?php if(!empty(get_static_option('home_page_build_dream_section_status'))): ?> checked <?php endif; ?> id="home_page_build_dream_section_status">
                                            <span class="slider"></span>
                                        </label>
                                    </div>
                                </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ktmsulaim/Sites/storksolutions/@core/resources/views/backend/pages/section-manage.blade.php ENDPATH**/ ?>