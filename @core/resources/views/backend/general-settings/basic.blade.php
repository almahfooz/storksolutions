                        ...
                        <form action="{{ route('admin.general.basic.settings') }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="site_footer_copyright" class="form-control"
                                    value="{{ get_static_option('site_footer_copyright') }}" id="site_footer_copyright">
                                <small class="form-text text-muted">{copy} Will replace by &copy; and {year} will be
                                    replaced by current year.</small>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="site_background_color">{{ __('Site Base Color Two Settings') }}</label>
                                <input type="text" name="site_background_color"
                                    style="background-color: {{ get_static_option('site_background_color') }};color: #fff;"
                                    class="form-control" value="{{ get_static_option('site_background_color') }}"
    ...
    <script>
        (function($) {
            ...
            $(document).ready(function() {
                ...
                showColorPicker('#site_color')
                showColorPicker('#site_main_color_two')
                showColorPicker('#site_background_color')
            });
        }(jQuery));
    </script>
@endsection
