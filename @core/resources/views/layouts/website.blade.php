        ...
        <!--Main Slider-->
        <section class="main-slider" style="background-image:url({{ asset('assets/frontend/finano/images/background/1.png') }})">
            <div class="main-slider-carousel owl-carousel owl-theme">

                <div class="slide slide-one" style="background-image:url(images/main-slider/1.png)">
                    <div class="auto-container">
                        <div class="content">
                            <h1>Our finance can give more <br> possiblities of <span>business</span></h1>
                            <div class="text">The argument in favor of using filler text goes something like
                                this: If you use real content in the design process, anytime you reach </div>
                            <div class="link-box">
                                <a href="contact.html" class="theme-btn btn-style-one">Let’s start now <span
                ...
                <div class="clearfix">
                    ...
                    <div class="services-block col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                            ...
                            <h5><a href="services-single.html">Finance <br> management</a></h5>
                            <div class="text">The argument in favor of using filler text goes some thing like
                                this</div>
                    ...
                    <div class="services-block col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                            ...
                            <h5><a href="services-single.html">Monthly growth <br> activities</a></h5>
                            <div class="text">The argument in favor of using filler text goes some thing like
                                this</div>
                            <a class="plus-box" href="services-single.html">View<span
                                    class="plus flaticon-plus-symbol"></span></a>
                    ...
                    <div class="services-block col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box wow fadeInLeft" data-wow-delay="600ms" data-wow-duration="1500ms">
                            ...
                            <h5><a href="services-single.html">Creative finance <br> idea</a></h5>
                            <div class="text">The argument in favor of using filler text goes some thing like
                                this</div>
                            <a class="plus-box" href="services-single.html">View<span
                                    class="plus flaticon-plus-symbol"></span></a>
                        ...
                        <div class="inner-column">
                            ...
                            <div class="text">
                                <p>The argument in favor of using filler text goes something like this: If you use real
                                    content in the <a href="#">design process,</a> anytime you reach a review point
                                ...
                                <p>Aenean tincidunt id mauris id auctor. Donec at ligula lacus. Nulla dignissim mi quis
                                    neque interdum, quis porta sem finibus.</p>
                            </div>
                            <div class="row clearfix">
                            ...
                            <div class="question">Call to ask <a href="#">any question</a>
                                <strong>540-325-1523</strong> <span class="or">or</span>
                                <strong>540-328-1265</strong></div>
                            <div class="signature">
                            ...
                            <div class="image">
                                ...
                                <div class="overlay-box">
                                    <div class="overlay-inner">
                                        <h3><a href="portfolio-single.html">Business Advisor</a></h3>
                                        <div class="text">The argument in favor of using filler text goes
                                            something consecte tur adipis elit sed eiusmod. </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="gallery-block">
                        <div class="inner-box">
                            <div class="image">
                                ...
                                <div class="overlay-box">
                                    <div class="overlay-inner">
                                        <h3><a href="portfolio-single.html">Branch Advisor</a></h3>
                                        <div class="text">The argument in favor of using filler text goes
                                            something consecte tur adipis elit sed eiusmod. </div>
                                    </div>
                                </div>
                    ...
                    <div class="gallery-block">
                        <div class="inner-box">
                            <div class="image">
                                ...
                                <div class="overlay-box">
                                    <div class="overlay-inner">
                                        <h3><a href="portfolio-single.html">Manager CEO</a></h3>
                                        <div class="text">The argument in favor of using filler text goes
                                            something consecte tur adipis elit sed eiusmod. </div>
                                    </div>
                                </div>
                ...
                <div class="single-item-carousel owl-carousel owl-theme">
                    ...
                    <div class="testimonial-block">
                        <div class="inner-box">
                            ...
                            <div class="text">The argument in favor of using filler text goes something like
                                this: If you use real content in the design preocess, anytime you reach a review point
                                you’ll end up reviewing and negotiating </div>
                            <h3>Robert Froast</h3>
            ...
            <div class="auto-container">
                ...
                <div class="sec-title centered">
                    ...
                    <div class="text">The argument in favor of using filler text goes something like this: If
                        you use real content in the design process, anytime you <br> reach a review point you’ll end up
                ...
                <div class="row clearfix">
                    ...
                    <!-- Services Block Two -->
                    <div class="services-block-two col-lg-4 col-md-12 col-sm-12">
                ...
                <div class="sec-title">
                    <div class="clearfix">
                        ...
                        <div class="pull-right">
                            <div class="text">The argument in favor of using filler text goes something like
                                this: If you use real content in the design process, anytime you reach a review point
                                you’ll end up reviewing and negotiating the content itself and not the design.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="case-block col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box">
                            ...
                            <h5><a href="services-single.html">Strategy for Norway's Pension Fund Global</a></h5>
                            <div class="text">This case study helps students understand the process of
                                setting, reporting and eva luating financial performance.</div>
                            <a href="services-single.html" class="arrow"><span
                                    class="flaticon-direction"></span></a>
                        </div>
                    </div>
                    ...
                    <div class="case-block col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box">
                            ...
                            <h5><a href="services-single.html">Ant Financial: Flourishing Farmer Loans at MYbank</a>
                            </h5>
                            <div class="text">This case study helps students understand the process of
                                setting, reporting and eva luating financial performance.</div>
                            <a href="services-single.html" class="arrow"><span
                    ...
                    <!-- Case Block -->
                    <div class="case-block col-lg-4 col-md-12 col-sm-12">
                        <div class="inner-box">
                            <div class="image">
                                <img src="images/resource/author-3.jpg" alt="" />
                            </div>
                            <div class="title">Investing</div>
                            <h5><a href="services-single.html">Low-Carbon Investing: Commonfund & GPSU</a></h5>
                            <div class="text">This case study helps students understand the process of
                                setting, reporting and eva luating financial performance.</div>
                            <a href="services-single.html" class="arrow"><span
                                    class="flaticon-direction"></span></a>
                    ...
                    <div class="title-column col-lg-4 col-md-12 col-sm-12">
                        <div class="inner-column">
                            ...
                            <div class="sec-title">
                                ...
                                <h2>Our team is very <br> expert to <span>help</span></h2>
                                <div class="text">The argument in favor of using filler text goes something
                                    like this: If you use real content in the design process, anytime you reach.</div>
                            </div>
                            <a href="team.html" class="theme-btn btn-style-one">View team <span
                                    class="icon flaticon-add-user-symbol-of-interface"></span></a>
                        </div>
                    </div>
        ...
        <section class="news-section">
            <div class="auto-container">
                    ...
                    <div class="news-block col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                            ...
                            <div class="lower-content">
                                ...
                                <div class="text">This case study helps students need to understand the
                                    process of setting report ting evaluating financial performance.</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="news-block col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                            ...
                            <div class="lower-content">
                                ...
                                <h5><a href="blog-single.html">What we are capable of the usually gets discovered.</a>
                                </h5>
                                <div class="text">This case study helps students need to understand the
                                    process of setting report ting evaluating financial performance.</div>
                            </div>
                ...
                <div class="btn-box text-center">
                    <a href="contact.html" class="theme-btn btn-style-one">View more <span
                            class="icon flaticon-eye"></span></a>
                </div>
                ...
                <div class="clearfix">
                    ...
                    <div class="right-column" style="background-image:url(images/resource/image-1.jpg)">
                        <div class="content">
                            ...
                            <div class="text">The argument in favor of using filler text goes something like
                                this: If you use real content in the design process.</div>
                                ...
                                <form method="post" action="contact.html">
                                    <div class="row clearfix">
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 col-sm-12">
                                            <input type="text" name="username" placeholder="How to assist you:*"
                                                required>
                                        </div>
